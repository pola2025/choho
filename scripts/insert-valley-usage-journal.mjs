...
const row = {
  ...
  title: "초호쉼터 계곡 이용 안내",
  excerpt:
    "충분한 수량이 확보되어 계곡 이용이 가능합니다. 수심은 발목~종아리 높이(깊은 곳 50~60cm)로 아이들이 놀기 좋아요. 펜션 투숙객 전용, 오후 6시까지 이용 가능합니다. (음주·화기·다이빙 등 제한)",
...
💧 이용 안내
- 수심은 발목 높이 정도이며, 깊은 곳도 50~60cm 수준입니다. 어린이들이 놀기 좋은 발목·종아리 높이예요.
