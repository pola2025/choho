// 저널 신규 1건 추가: 시원한 여름 프로모션(더초리골 수영장 무료입장 2인권) — 멱등(동일 id 삭제 후 삽입)
...
const row = {
  id,
  title: "시원한 여름 프로모션 — 더초리골 수영장 무료입장 2인권 안내",
  excerpt:
    "8월 3일(월)부터 8월 16일(일)까지 입실하시는 고객님께 더초리골 수영장 무료입장 2인권을 드립니다. 무료 2인을 제외한 나머지 인원은 50% 할인권으로 제공되며, 객실 예약 시 사전 신청이 필요합니다.",
  content: `무더위가 이어지는 8월, 초호펜션에서 시원한 여름 프로모션을 준비했습니다.
8월 3일(월)부터 8월 16일(일)까지 입실하시는 고객님께 더초리골 수영장 입장권을 드립니다.

■ 제공 혜택
- 무료입장 2인권 (2인 무료 입장)
- 무료 2인을 제외한 나머지 인원은 50% 할인권으로 제공 (객실 이용인원 기준)

■ 이용 예시
- Forest 4인 예약 → 무료 2인 + 50% 할인권 2인
- 호수뷰 객실 6인 예약 → 무료 2인 + 50% 할인권 4인
...
■ 이용 조건
- 무료 2인권은 주간 / 야간 중 하나를 선택해 사용하실 수 있습니다. (종일 사용 불가)
- 50% 할인권은 종일권 구매 시에도 할인 적용이 가능합니다.
- 수영장 야간개장은 토·일 18:00~21:50에 운영하며, 8월 16일(일)까지입니다. (평일 야간 미운영)
