          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-10 h-10 rounded-full bg-neutral-800 hover:bg-gradient-to-br hover:from-purple-500 hover:via-pink-500 hover:to-orange-500 flex items-center justify-center transition-all duration-300"
              ...
              <a
                ...
                className="w-10 h-10 rounded-full bg-neutral-800 hover:bg-primary flex items-center justify-center transition-all duration-300"
                aria-label="전화"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-neutral-800 hover:bg-green-600 flex items-center justify-center transition-all duration-300"
                aria-label="위치"
              >
                <MapPin className="w-5 h-5 text-neutral-400 hover:text-white" />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                ...
                >
                  <div className="w-9 h-9 rounded-lg bg-neutral-800 group-hover:bg-primary/20 flex items-center justify-center transition-colors">
              ...
              <li>
                ...
                >
                  <div className="w-9 h-9 rounded-lg bg-neutral-800 group-hover:bg-primary/20 flex items-center justify-center shrink-0 transition-colors">
