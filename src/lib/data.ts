...
export const rooms: Room[] = [
  ...
  },
  {
    ...
    slug: "forest-family",
    type: "ondol",
    capacity: { standard: 5, maximum: 5, label: "정원 4명 + 유아 1명" },
    area: 12,
    description:
  ...
  },
  {
    ...
    type: "ondol",
    capacity: { standard: 3, maximum: 3, label: "정원 2명 + 유아 1명" },
    area: 8,
    description:
...
export const journals: Journal[] = [
  {
    ...
    excerpt:
      "초호펜션 투숙객은 초리골164 카페에서 추가 음료 구매 시 20% 할인! 커피쿠폰은 기본 제공됩니다.",
    isPublished: true,
    content: `초호펜션 투숙객 전용 카페 할인 혜택 안내

☕ 커피쿠폰: 기준인원 + 추가인원 모두 기본 제공 (기존과 동일)
🥤 추가 음료 구매 시: 20% 할인

📌 이용 안내:
- 체크인 시 초리골164 베이커리 카페에서 바로 이용 가능
- 기준인원 + 추가인원 모두 커피쿠폰 제공
- 커피쿠폰 외 추가로 음료를 드시고 싶은 분들께 20% 할인 적용
